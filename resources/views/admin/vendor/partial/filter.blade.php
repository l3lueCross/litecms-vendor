<div class="btn-group vendor-vendor">
...
$(document).ready(function(){
    ...
    $(".vendor-vendor .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/vendor.vendor.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".vendor-vendor .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.vendor-vendor .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'vendor.vendor.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#vendor-vendor-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#vendor-vendor-list .btn-reset-filter').css('display', 'none');
